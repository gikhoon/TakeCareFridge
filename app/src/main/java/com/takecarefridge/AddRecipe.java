    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_uploadRecipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String link = editText_link.getText().toString();
                //데이터를 입력했다면
                if ((imageUri != null) && (name != null) && (ingredient != null) && (link != null)) {
                    insertData(name, ingredient, imageUri, link);
                    goRecipeMain(view);
                } else {
                    if (imageUri != null) {
                    ...
                    if (name.length() < 1) {
                        Toast.makeText(AddRecipe.this, "레시피 이름을 입력해주세요.", Toast.LENGTH_SHORT).show();
                    }
                    if (ingredient.length() < 1) {
                        Toast.makeText(AddRecipe.this, "레시피 재료목록을 입력해주세요.", Toast.LENGTH_SHORT).show();
                    }
                    if (link.length() < 1) {
                        Toast.makeText(AddRecipe.this, "레시피 링크를 입력해주세요.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if( result.getResultCode() == RESULT_OK && result.getData() != null){
                        ...
                        Log.d("11111", String.valueOf(imageUri));
